    ...
    <section className="page page-services">
      <div className="section-header">
        ...
        <nav className="service-nav" aria-label="Jump to service sections">
          <a href="#bouquets" className="service-pill" aria-label="Jump to bouquets section">
            Bouquets
          </a>
          <a href="#arrangements" className="service-pill" aria-label="Jump to arrangements section">
            Arrangements
          </a>
